...
<body>
    <?php
    $sensor_url="http://localhost:8080/geoserver/CHORDS/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=CHORDS:Sensor&maxFeatures=50&outputFormat=json";
